...
namespace IPFBrowser.FileFormats.IPF
{
	public class Ipf
	{
		...
		public void Load()
		{
			...
			this.Footer.FileTableOffset = _br.ReadUInt32();
			this.Footer.Val1 = _br.ReadUInt16();
            this.Footer.Val2 = _br.ReadUInt32();
            this.Footer.Compression = _br.ReadUInt32();
    ...
    public static class CRC32
    {
        ...
        public static unsafe uint crc32(uint crc, byte[] buf)
        {
